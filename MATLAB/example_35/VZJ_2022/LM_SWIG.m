...
for approach = 1:2
    for soil_type = 1:n_soil
        ...
        [eta_opt,SSR_opt,K] = least_squares_haverkamp(t_meas,I_meas,approach,eta_min,eta_max,nu,Ntrials);
        ...
        [std_opt,r90,r95] = det_uncertainty(I_meas,t_meas,eta_opt(zz,1:3),SSR_opt(zz),eta_min,eta_max,n_data,approach);
        % Now store 95% 
...
% Save optimal values
save SWIG_646_LM_test10_Jac opt_LM_SWIG SSR_LM_SWIG data_SWIG n_soil Data min95 max95 min90 max90 LM_res_SWIG
